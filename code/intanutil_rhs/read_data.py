...
def read_data(filename):
    ...
    if (data_present):
        ...
        if header['notch_filter_frequency'] > 0 and header['version']['major'] < 3:
            print(f'! WARNING: The software notch filter was selected during the recording, applying the same notch filter ({header["notch_filter_frequency"]} Hz) to amplifier data here !')
            print_increment = 10
            percent_done = print_increment
